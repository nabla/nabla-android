...
internal class GqlAppointmentConfirmConsentsDataSource(
    ...
    suspend fun getConfirmConsents(appointmentLocation: AppointmentLocation): AppointmentConfirmationConsents {
        return apolloClient.query(AppointmentConfirmationConsentsQuery())
            .fetchPolicy(FetchPolicy.NetworkFirst)
            .execute()
            .dataOrThrowOnError
            .appointmentConfirmationConsents
            .let { mapper.mapToAppointmentConfirmationConsents(it, appointmentLocation) }
    }
}
