...
internal class ConversationProviderTextCellTest : BaseCoroutineTest() {
    ...
    fun `test provider short text`() = paparazzi.snapshotDayNightDefaultDevice { (context, layoutInflater) ->
        val (parent, viewHolder) = createProviderTextViewHolder(context, layoutInflater)
    ...
    @Test
    fun `test provider long text`() = paparazzi.snapshotDayNightMultiDevices { (context, layoutInflater) ->
        val (parent, viewHolder) = createProviderTextViewHolder(context, layoutInflater)
    ...
    @Test
    fun `test provider short text responding to a short patient text`() = paparazzi.snapshotDayNightDefaultDevice { (context, layoutInflater) ->
        val (parent, viewHolder) = createProviderTextViewHolder(context, layoutInflater)
    ...
    @Test
    fun `test provider long text responding to a short patient text`() = paparazzi.snapshotDayNightMultiDevices { (context, layoutInflater) ->
        val (parent, viewHolder) = createProviderTextViewHolder(context, layoutInflater)
    ...
    @Test
    fun `test provider short text responding to a long patient text`() = paparazzi.snapshotDayNightDefaultDevice { (context, layoutInflater) ->
        val (parent, viewHolder) = createProviderTextViewHolder(context, layoutInflater)
    ...
    @Test
    fun `test provider long text responding to a long patient text`() = paparazzi.snapshotDayNightMultiDevices { (context, layoutInflater) ->
        val (parent, viewHolder) = createProviderTextViewHolder(context, layoutInflater)
    ...
    @Test
    fun `test provider short text responding to an image patient sent`() = paparazzi.snapshotDayNightDefaultDevice { (context, layoutInflater) ->
        val (parent, viewHolder) = createProviderTextViewHolder(context, layoutInflater)
    ...
    @Test
    fun `test provider long text responding to an image patient sent`() = paparazzi.snapshotDayNightMultiDevices { (context, layoutInflater) ->
        val (parent, viewHolder) = createProviderTextViewHolder(context, layoutInflater)
    ...
    @Test
    fun `test provider short text responding to a video patient sent`() = paparazzi.snapshotDayNightDefaultDevice { (context, layoutInflater) ->
        val (parent, viewHolder) = createProviderTextViewHolder(context, layoutInflater)
    ...
    @Test
    fun `test provider long text responding to a video patient sent`() = paparazzi.snapshotDayNightMultiDevices { (context, layoutInflater) ->
        val (parent, viewHolder) = createProviderTextViewHolder(context, layoutInflater)
    ...
    @Test
    fun `test provider short text responding to a document patient sent`() = paparazzi.snapshotDayNightDefaultDevice { (context, layoutInflater) ->
        val (parent, viewHolder) = createProviderTextViewHolder(context, layoutInflater)
    ...
    @Test
    fun `test provider long text responding to a document patient sent`() = paparazzi.snapshotDayNightMultiDevices { (context, layoutInflater) ->
        val (parent, viewHolder) = createProviderTextViewHolder(context, layoutInflater)
    ...
    @Test
    fun `test provider short text responding to an audio patient sent`() = paparazzi.snapshotDayNightDefaultDevice { (context, layoutInflater) ->
        val (parent, viewHolder) = createProviderTextViewHolder(context, layoutInflater)
    ...
    @Test
    fun `test provider long text responding to an audio patient sent`() = paparazzi.snapshotDayNightMultiDevices { (context, layoutInflater) ->
        val (parent, viewHolder) = createProviderTextViewHolder(context, layoutInflater)
    ...
    private fun ProviderTextMessageViewHolder.bindFakeTextContent(content: TimelineItem.Message.Text) {
    ...
    private fun createProviderTextViewHolder(context: Context, layoutInflater: LayoutInflater): Pair<View, ProviderTextMessageViewHolder> {
        val parent = FrameLayout(context.withNablaMessagingThemeOverlays())
        parent.setPadding(0, 50, 0, 50)
        val viewHolder = ProviderTextMessageViewHolder.create(
