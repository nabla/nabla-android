...
internal class ConversationPatientMediaCellTest : BaseCoroutineTest() {
    ...
    fun `test patient image`() = paparazzi.snapshotDayNightDefaultDevice { (context, layoutInflater) ->
        ...
        val viewHolder = PatientImageMessageViewHolder.create(
    ...
    @Test
    fun `test patient video`() = paparazzi.snapshotDayNightDefaultDevice { (context, layoutInflater) ->
        val parent = FrameLayout(context.withNablaMessagingThemeOverlays())
        parent.setPadding(0, 50, 0, 50)
        val viewHolder = PatientVideoMessageViewHolder.create(
            inflater = layoutInflater.cloneInContext(context.withNablaMessagingThemeOverlays()),
            parent = parent,
    ...
    @Test
    fun `test patient document with thumbnail`() = paparazzi.snapshotDayNightDefaultDevice { (context, layoutInflater) ->
        val parent = FrameLayout(context.withNablaMessagingThemeOverlays())
        parent.setPadding(0, 50, 0, 50)
        val viewHolder = PatientFileMessageViewHolder.create(
            inflater = layoutInflater.cloneInContext(context.withNablaMessagingThemeOverlays()),
            parent = parent,
        )
    ...
    @Test
    fun `test patient document without thumbnail`() = paparazzi.snapshotDayNightDefaultDevice { (context, layoutInflater) ->
        val parent = FrameLayout(context.withNablaMessagingThemeOverlays())
        parent.setPadding(0, 50, 0, 50)
        val viewHolder = PatientFileMessageViewHolder.create(
            inflater = layoutInflater.cloneInContext(context.withNablaMessagingThemeOverlays()),
    ...
    @Test
    fun `test patient audio not playing at 0 percent`() = paparazzi.snapshotDayNightDefaultDevice(offsetMillis = 250) { (context, layoutInflater) ->
    ...
    @Test
    fun `test patient audio not playing at 50 percent`() = paparazzi.snapshotDayNightDefaultDevice(offsetMillis = 250) { (context, layoutInflater) ->
        createAudioMessageMessageView(
            context = context,
            layoutInflater = layoutInflater,
            playing = false,
    ...
    @Test
    fun `test patient audio not playing at 100 percent`() = paparazzi.snapshotDayNightDefaultDevice(offsetMillis = 250) { (context, layoutInflater) ->
        createAudioMessageMessageView(
            context = context,
            layoutInflater = layoutInflater,
            playing = false,
    ...
    @Test
    fun `test patient audio playing at 0 percent`() = paparazzi.snapshotDayNightDefaultDevice(offsetMillis = 250) { (context, layoutInflater) ->
        createAudioMessageMessageView(
            context = context,
            layoutInflater = layoutInflater,
            playing = true,
    ...
    @Test
    fun `test patient audio playing at 50 percent`() = paparazzi.snapshotDayNightDefaultDevice(offsetMillis = 250) { (context, layoutInflater) ->
        createAudioMessageMessageView(
            context = context,
            layoutInflater = layoutInflater,
            playing = true,
    ...
    @Test
    fun `test patient audio playing at 100 percent`() = paparazzi.snapshotDayNightDefaultDevice(offsetMillis = 250) { (context, layoutInflater) ->
        createAudioMessageMessageView(
            context = context,
            layoutInflater = layoutInflater,
            playing = true,
    ...
    private fun createAudioMessageMessageView(
        ...
        val parent = FrameLayout(context.withNablaMessagingThemeOverlays())
        parent.setPadding(0, 50, 0, 50)
        val viewHolder = PatientAudioMessageViewHolder.create(
            inflater = layoutInflater.cloneInContext(context.withNablaMessagingThemeOverlays()),
            parent = parent,
    ...
    private fun <C : TimelineItem.Message.Content, B : MessageContentBinder<C>> PatientMessageViewHolder<C, B>.bindContent(content: C) {
        bind(
